...
# Example of a 
```{python}
# Ensure the column is numeric and convert to integers
result_gdf['pop_25_bach_plus'] = result_gdf['pop_25_bach_plus'].astype(float)

result_gdf.plot(
    column='pop_25_bach_plus',  # 25 years and over: Bachelor's degree or higher
    cmap='viridis',            # Colormap (adjust as needed)
...
plt.title("Population with Bachelor's Degree or Higher (25+)")
